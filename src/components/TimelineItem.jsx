...
function TimelineItem({ year, title, duration, details }) {
    return (
        <ol className="flex flex-col md:flex-row relative border-l border-stone-200 dark:border-stone-200 ">
          ...
          <span className="inline-block px-2 py-1 font-semibold text-white dark:text-stone-900 bg-stone-900 dark:bg-white rounded-md">
            {year}
                ...
                <p className="my-2 text-base font-normal text-stone-500 dark:text-stone-400" style={{ whiteSpace: 'pre-wrap' }}>
                    {details}
                </p>
            </li>
        </ol>
